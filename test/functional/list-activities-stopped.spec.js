...
test('make sure return activities stopped from a project', async ({ assert, client }) => {
  const user = await User.create({ username: 'test9', password: '123456', email: 'fake9@mail' })
