...
test('make sure create a activity when valid arguments are provided', async ({ assert, client }) => {
  ...
  const activity = { description: 'test', initial_date: '2020-01-01', final_date: '2020-01-01' }
